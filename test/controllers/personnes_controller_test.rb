...
class PersonnesControllerTest < ActionController::TestCase
  ...
  test "should create personne" do
    assert_difference('Personne.count') do
      post :create, personne: { birthdate: @personne.birthdate, name: @personne.name, phone: @personne.phone, surname: @personne.surname }
    end
  ...
  test "should update personne" do
    patch :update, id: @personne, personne: { birthdate: @personne.birthdate, name: @personne.name, phone: @personne.phone, surname: @personne.surname }
    assert_redirected_to personne_path(assigns(:personne))
  end
